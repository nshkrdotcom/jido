defmodule JidoTest.Actions.SimplebotTest do
  ...
  describe "Move" do
    test "moves the robot to the specified destination" do
      ...
      assert {:ok, result} = Simplebot.Move.run(params, %{})
  ...
  describe "Idle" do
    test "does nothing and returns the same params" do
      params = %{some: :data}
      assert {:ok, ^params} = Simplebot.Idle.run(params, %{})
    end
  end
  ...
  describe "DoWork" do
    test "decreases battery level" do
      ...
      assert {:ok, result} = Simplebot.DoWork.run(params, %{})
  ...
  describe "Report" do
    test "marks the robot as having reported" do
      ...
      assert {:ok, result} = Simplebot.Report.run(params, %{})
  ...
  describe "Recharge" do
    test "increases battery level" do
      ...
      assert {:ok, result} = Simplebot.Recharge.run(params, %{})
