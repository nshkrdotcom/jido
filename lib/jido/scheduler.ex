defmodule Jido.Scheduler do
  ...
  This scheduler is used by the included `Jido.CronSensor` module to manage cron jobs and emit signals
  on schedule. The CronSensor provides a high-level interface for:
  ...
  See `Jido.CronSensor` documentation for usage examples and configuration options.
  """
